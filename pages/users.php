            ...
            <tbody>
              ...
              ?>
                ...
                <th scope="col"><a href="./editUser.php">
                  <div class="row">
                    <div class="col-3">
                    <a href="./editUser.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm text-white">Edit</a>

                    </div>
                    <div class="col-3">
                    <form method="post">
                      <input type="hidden" value="<?php echo $row['id']; ?>" name="user_id">
                      <button type="submit" name="delete-user-submit" class="btn btn-danger btn-sm">Delete</button></th>
                    </form>
                    </div>
