...
--
-- Host: localhost:3306
-- Generation Time: May 23, 2023 at 05:37 PM
...
--
CREATE DATABASE IF NOT EXISTS `nabilproject1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8_general_ci;
USE `nabilproject1`;
...
CREATE TABLE `files` (
  ...
  `file_name` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `users` (
  `id` int NOT NULL,
  `username` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
  `email` varchar(50) NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
  `file_size` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
  `file_lim` int NOT NULL,
  `folder_name` text CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
